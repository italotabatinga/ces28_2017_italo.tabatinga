...
public class PersonDetailView extends JPanel implements PersonListener, WindowListener{
	...
	public PersonDetailViewListenerMVC getPresenter() {
		return _presenter;
	}

	public void setController(PersonDetailViewListenerMVC presenter) {
	...
	private PersonDetailViewListenerMVC _presenter;
